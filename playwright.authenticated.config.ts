...
const journeyAndGeometry =
  /(?:onboarding|customization-geometry|firebase-auth-hydration|flexible-routine-publication|library-guidance|library-strength-expansion|library-core-conditioning-expansion|runner-resilience)\.spec\.ts/u;
