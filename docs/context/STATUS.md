...
- `pnpm typecheck`, `pnpm lint`, 157 unit and integration tests, generated-service-worker parity, `pnpm docs:check`, and a production build pass after the reviewed YouTube and interruption-safe runner integrations.
