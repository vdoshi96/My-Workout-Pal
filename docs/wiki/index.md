...
- `docs/plans/WAVE-1-PRODUCTION-RELEASE.md`: exact release identities, read-only preflight, restore-tested recovery, ordered production migrations, hosted verification, and cleanup gates.
